...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Bank A', description: 'Name of the bank' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateDepositDto.prototype, "bank", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 2.5, description: 'Interest rate of the deposit' }),
