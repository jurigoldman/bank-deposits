...
export declare const BankOfferSchema: import("mongoose").Schema<BankOffer, import("mongoose").Model<BankOffer, any, any, any, Document<unknown, any, BankOffer, any> & BankOffer & Required<{
    _id: unknown;
}> & {
    __v: number;
