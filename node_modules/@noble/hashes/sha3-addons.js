...
const toBytesOptional = (buf) => (buf !== undefined ? (0, utils_ts_1.toBytes)(buf) : new Uint8Array([]));
...
const gencShake = (suffix, blockLen, outputLen) => (0, utils_ts_1.wrapXOFConstructorWithOpts)((opts = {}) => cshakePers(new sha3_ts_1.Keccak(blockLen, suffix, chooseLen(opts, outputLen), true), opts));
...
const genTurboshake = (blockLen, outputLen) => (0, utils_ts_1.wrapXOFConstructorWithOpts)((opts = {}) => {
...
exports.k12 = (() => (0, utils_ts_1.wrapConstructorWithOpts)((opts = {}) => new KangarooTwelve(168, 32, chooseLen(opts, 32), 12, opts)))();
/** MarsupilamiFourteen: reduced 14-round keccak. */
exports.m14 = (() => (0, utils_ts_1.wrapConstructorWithOpts)((opts = {}) => new KangarooTwelve(136, 64, chooseLen(opts, 64), 14, opts)))();
/**
 * More at https://github.com/XKCP/XKCP/tree/master/lib/high/Keccak/PRG.
 */
class KeccakPRG extends sha3_ts_1.Keccak {
    constructor(capacity) {
        (0, _assert_ts_1.anumber)(capacity);
