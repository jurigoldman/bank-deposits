...
class BLAKE3 extends _blake_ts_1.BLAKE {
    constructor(opts = {}, flags = 0) {
        ...
        this.enableXOF = true;
        (0, _assert_ts_1.anumber)(this.outputLen);
        if (opts.key !== undefined && opts.context !== undefined)
            throw new Error('Blake3: only key or context can be specified at same time');
        else if (opts.key !== undefined) {
            const key = (0, utils_ts_1.toBytes)(opts.key).slice();
            if (key.length !== 32)
                throw new Error('Blake3: key should be 32 byte');
            this.IV = (0, utils_ts_1.u32)(key);
            if (!utils_ts_1.isLE)
                (0, utils_ts_1.byteSwap32)(this.IV);
            ...
            const context_key = new BLAKE3({ dkLen: 32 }, B3_Flags.DERIVE_KEY_CONTEXT)
                .update(opts.context)
                .digest();
            this.IV = (0, utils_ts_1.u32)(context_key);
            if (!utils_ts_1.isLE)
                (0, utils_ts_1.byteSwap32)(this.IV);
            this.flags = flags | B3_Flags.DERIVE_KEY_MATERIAL;
        }
        else {
            this.IV = blake2s_ts_1.B2S_IV.slice();
            this.flags = flags;
        }
    ...
    b2Compress(counter, flags, buf, bufPos = 0) {
        ...
        // prettier-ignore
        const { v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15 } = (0, blake2s_ts_1.compress)(SIGMA, bufPos, buf, 7, s[0], s[1], s[2], s[3], s[4], s[5], s[6], s[7], blake2s_ts_1.B2S_IV[0], blake2s_ts_1.B2S_IV[1], blake2s_ts_1.B2S_IV[2], blake2s_ts_1.B2S_IV[3], h, l, pos, flags);
        s[0] = v0 ^ v8;
        s[1] = v1 ^ v9;
        s[2] = v2 ^ v10;
        s[3] = v3 ^ v11;
    ...
    b2CompressOut() {
        ...
        // prettier-ignore
        const { v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15 } = (0, blake2s_ts_1.compress)(SIGMA, 0, buffer32, 7, s[0], s[1], s[2], s[3], s[4], s[5], s[6], s[7], blake2s_ts_1.B2S_IV[0], blake2s_ts_1.B2S_IV[1], blake2s_ts_1.B2S_IV[2], blake2s_ts_1.B2S_IV[3], l, h, pos, flags);
        out32[0] = v0 ^ v8;
        out32[1] = v1 ^ v9;
        out32[2] = v2 ^ v10;
        out32[3] = v3 ^ v11;
    ...
    finish() {
        ...
        if (this.stack.length) {
            ...
            if (!utils_ts_1.isLE)
                (0, utils_ts_1.byteSwap32)(this.buffer32);
 ...
 */
exports.blake3 = (0, utils_ts_1.wrapXOFConstructorWithOpts)((opts) => new BLAKE3(opts));
