...
function scryptInit(password, salt, _opts) {
    ...
    (0, _assert_ts_1.anumber)(N);
    (0, _assert_ts_1.anumber)(r);
    (0, _assert_ts_1.anumber)(p);
    (0, _assert_ts_1.anumber)(dkLen);
    (0, _assert_ts_1.anumber)(asyncTick);
    (0, _assert_ts_1.anumber)(maxmem);
    ...
    const B = (0, pbkdf2_ts_1.pbkdf2)(sha256_ts_1.sha256, password, salt, { c: 1, dkLen: blockSize * p });
...
function scryptOutput(password, dkLen, B, V, tmp) {
    const res = (0, pbkdf2_ts_1.pbkdf2)(sha256_ts_1.sha256, password, B, { c: 1, dkLen });
    B.fill(0);
    V.fill(0);
    tmp.fill(0);
    return res;
