...
function xor32(a, b) {
    (0, _assert_ts_1.abytes)(a, 32);
    (0, _assert_ts_1.abytes)(b, 32);
...
function getSaltInfo(protocol, accountId = 0) {
    ...
    if (typeof accountId === 'string') {
        ...
        salt = (0, utils_ts_1.toBytes)(accountId);
    }
    ...
    const info = (0, utils_ts_1.toBytes)(protocol);
    return { salt, info };
}
